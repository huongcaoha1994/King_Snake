...
//        GraphicsContext gc = canvas.getGraphicsContext2D();
        ...
        gridPane.add(imageView7, 0, 13);

        // TextField 7
        Text text7 = new Text("GateSpace : Chỉ xuất hiện khi bạn có đủ 15 key , đi qua nó để qua màn chơi");
        text7.setFont(Font.font("Arial", fontSize));
        gridPane.add(text7, 1, 13);
