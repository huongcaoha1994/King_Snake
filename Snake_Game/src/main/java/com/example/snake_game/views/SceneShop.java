...
public class SceneShop {
    ...
    public static Scene shop(String username){
        ...
        Button price2 = new Button("15000 coin");
        ...
        Button price3 = new Button("20000 coin");
        ...
        Button price4 = new Button("25000 coin");
        ...
        Button price5 = new Button("30000 coin");
        ...
        Button button2 = SetButtonBuy.setButton(2,15000,username);
        gridPane.add(button2, 1, 6);

        Button button3 = SetButtonBuy.setButton(3,20000,username);
        gridPane.add(button3, 2, 6);

        Button button4 = SetButtonBuy.setButton(4,25000,username);
        gridPane.add(button4, 3, 6);

        Button button5 = SetButtonBuy.setButton(5,30000,username);
